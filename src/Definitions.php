...
final class Definitions {
    ...
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'tenant_id', 'uuid', 'uuid_bin', 'public_order_no', 'user_id', 'status', 'encrypted_customer_blob', 'encrypted_customer_blob_key_version', 'encryption_meta', 'currency', 'metadata', 'subtotal', 'discount_total', 'tax_total', 'total', 'payment_method', 'created_at', 'updated_at', 'version' ]; }
    ...
    public static function uniqueKeys(): array { return [ [ 'uuid_bin' ], [ 'tenant_id', 'uuid_bin' ], [ 'tenant_id', 'public_order_no' ], [ 'tenant_id', 'id' ], [ 'uuid' ], [ 'id' ] ]; }
    ...
    public static function intColumns(): array { return [ 'id', 'tenant_id', 'user_id', 'version' ]; }
