...
final class OrderDtoMapper
{
    ...
    /** @var string[] */
    private const NULLABLE    = [ 'id', 'uuid_bin', 'public_order_no', 'user_id', 'encrypted_customer_blob', 'encrypted_customer_blob_key_version', 'encryption_meta', 'metadata', 'payment_method' ];
